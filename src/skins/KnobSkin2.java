...
public class KnobSkin2 extends SkinBase<Knob>{
  ...
  private void initGraphics(){
        ...
        for (double angle = 0, counter = 0; counter <= getSkinnable().getMaxValue() ; angle -=angleStep, counter++) {
            ...
            double center_radiusX_ = (centerX * 0.93)  * sinValue + centerX;
            double center_radiusY_ = (centerY * 0.93)  * cosValue + centerY;
            ...
            if(counter % 10 == 0 && counter > 0){
              ...
              // minor tick marks 
                ...
                gc.strokeLine(center_radiusX, center_radiusY, center_radiusX_,center_radiusY_);  
